...
;; Inspired by:
;;
;; https://bitbucket.org/kisom/greyink.vim
;; https://github.com/dmand/greyink.el
...
(let ((fg "#111111")
      ...
      (fg-light "#ddddd8")
      (bg-highlight "#ededed")
      (bg-highlight-2 "#f5f5f5")
      (bg-highlight-3 "#c7c7c7"))
...
(provide-theme 'greyink)
;;; greyink-theme.el ends here
